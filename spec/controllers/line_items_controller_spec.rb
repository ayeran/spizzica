  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved line_item as @line_item" do
        ...
        post :create, {:line_item => { "item_id" => "invalid value" }}, valid_session
        assigns(:line_item).should be_a_new(LineItem)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested line_item" do
        ...
        LineItem.any_instance.should_receive(:update_attributes).with({ "item_id" => "1" })
        put :update, {:id => line_item.to_param, :line_item => { "item_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the line_item as @line_item" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        LineItem.any_instance.stub(:save).and_return(false)
        put :update, {:id => line_item.to_param, :line_item => { "item_id" => "invalid value" }}, valid_session
        assigns(:line_item).should eq(line_item)
      end
