  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved beverage as @beverage" do
        ...
        post :create, {:beverage => { "name" => "invalid value" }}, valid_session
        assigns(:beverage).should be_a_new(Beverage)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested beverage" do
        ...
        Beverage.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => beverage.to_param, :beverage => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the beverage as @beverage" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Beverage.any_instance.stub(:save).and_return(false)
        put :update, {:id => beverage.to_param, :beverage => { "name" => "invalid value" }}, valid_session
        assigns(:beverage).should eq(beverage)
      end
